.PHONY: i install check test sim view auto auto-gp control-flight manual free-port probe est-selftest doc-context doc-validate doc-update capture-gates fly fly-vision fly-vision-est hover dynamics vertical capture dataset train-gatenet train-ppo fly-policy rl-test log-demos train-bc
